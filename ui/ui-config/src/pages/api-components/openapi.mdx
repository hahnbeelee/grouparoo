...
<Note>
  The method endpoint must match the endpoint specified in the OpenAPI specifications exactly.
  Nothing is displayed if the endpoint doesn't exist in the OpenAPI file.
</Note>
